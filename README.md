...
Geolocation service — facility registry, GPS tracking, health zones
...
git clone https://github.com/zarishsphere/zs-svc-geo.git
cd zs-svc-geo
...
See [docs.zarishsphere.com/api/zs-svc-geo](https://docs.zarishsphere.com/api/zs-svc-geo) for the full OpenAPI 3.1 specification.
